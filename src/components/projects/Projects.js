...
export const projects = [
    ...
    },
    {
        ...
        event: "Concours Ubisoft 2019 (Thème: Le Spectacle)",
        description:
            "Quatre zombies s'affrontent dans un show télévisé délirant! Pour libérer son zombie, le joueur devra sortir vainqueur d'épreuves délirantes, battre un présentateur fou, et survivre aux pièges des téléspectateurs!",
        participants: [
            "Alexandre Turcotte",
            "Arthur Gagnon",
            "Didier Gerschheimer",
    ...
    },
    {
        ...
        event: "Concours Ubisoft 2018 (Thème: Changer le Monde)",
        description:
            "Qu'est-ce qui est plus important pour vous? Éviter de gaspiller de l'eau pour sauver la planète en flammes ou avoir un terrain plus propre que celui de ton voisin? La réponse est clairement avoir un terrain plus propre! Accumule des points en nettoyant plus d'objets que ton adversaire avant que le temps ne s'écoule.",
        participants: [
            "Francis Beauchemin",
            "Jimmy Dumont",
            "Marc-Andrée Perreault",
            "Jérémie Bolduc",
            "Alex Gilbert",
            "Isabelle Dussault",
            "Gabriel Laroque",
    ...
    // },
    // {
    //     title: "Season Of Chaos",
    //     event: "Concours Ubisoft 2017",
    //     description: "",
    //     participants: [],
    //     imagePath: "logo.png"
    // }
